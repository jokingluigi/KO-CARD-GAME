...
Online match creation must pass the enabled public media catalog into the shared startGame call; an empty catalog leaves bgmId null and prevents the online client from honoring the state-based audio policy.
