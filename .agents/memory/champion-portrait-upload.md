...
**How to apply:** Reuse the authenticated card-image upload flow for both asset types, validate new upload tokens server-side, and keep cleanup reference-aware across cards and both Champion portrait columns.