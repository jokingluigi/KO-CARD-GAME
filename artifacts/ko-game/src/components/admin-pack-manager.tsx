...
type Pack = { id: string; name: string; description: string; imageUrl: string | null; cardsPerPack: number; normalRate: number; legendaryRate: number; championRate: number; skinChance: number; normalCardPool: string[]; legendaryCardPool: string[]; championPool: string[]; skinPool: string[]; status: string; };
...
const blank: Omit<Pack, "id" | "status"> = { name: "", description: "", imageUrl: null, cardsPerPack: 1, normalRate: 90, legendaryRate: 7, championRate: 3, skinChance: 0, normalCardPool: [], legendaryCardPool: [], championPool: [], skinPool: [] };
